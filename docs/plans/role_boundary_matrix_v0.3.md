# Loop Engineering Role / Boundary Matrix v0.3
...
The integration owner is responsible for completeness of its declared effect surface.
...
Every declared capability boundary MUST identify:
...
For effect-capable capabilities, additionally:
